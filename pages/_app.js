            ...
            <div className="md:flex flex-row gap-5 md:w-full">
              ...
              <div className="md:ml-80 md:flex md:flex-row">
                ...
                {/* {isConnectedWallet ? (
                  ...
                  <div
                    className="bg-blue-600 md:bg-slate-800 lg:ml-10 px-2 mt-4 lg:mt-0 text-white py-3 lg:px-10 flex justify-center gap-4 rounded-xl"
