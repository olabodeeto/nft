...
export default function Home() {
  ...
  return (
    <>
      <main className="mt-48 w-full px-1 lg:w-10/12 m-auto">
      ...
      {loadingState === "loaded" && !nfts.length ? (
        ...
        <>
          <div className="sitebg min-h-60 overflow-scroll py-16 pb-40 mt-60">
              ...
              <div className="px-4" style={{ maxWidth: "1600px" }}>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-4">
                  {nfts.map((nft, i) => (
                    <div
                      key={i}
                      className="border shadow rounded-xl overflow-hidden flex flex-col justify-between bg-white relative"
                    >
                      <img src={nft.image} />
                      ...
                      <div className="p-4 bg-black bottom-0">
